...
| Rationale and doc refs | Source rationale comments are indexed | Add Markdown/ADR/RFC/doc link extraction and link docs to code nodes |
| Beyond code | Not yet first-class beyond manifests/config | Add deterministic docs and SQL first, then optional model-backed PDFs/images/media sidecars |
