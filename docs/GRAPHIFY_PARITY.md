...
| --- | --- | --- |
| Local AST code graph | Implemented for 30 languages (Rust, Python, JS/TS/TSX, Go, C, C++, Dart, PHP, Bash, Ruby, Java, C#, Kotlin, Swift, Scala, Lua, Elixir, Zig, Haskell, OCaml, Julia, Erlang, Nix, R, HCL, Protobuf, GraphQL, Solidity) | Continue expanding language adapters while preserving typed facts and provenance |
