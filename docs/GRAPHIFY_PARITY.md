...
| --- | --- | --- |
| Local AST code graph | Implemented for 14 languages (Rust, Python, JS/TS/TSX, Go, C, C++, Dart, PHP, Bash, Ruby, Java, C#) | Continue expanding language adapters while preserving typed facts and provenance |
