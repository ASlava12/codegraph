...
| --- | --- | --- |
| Local AST code graph | Implemented for 23 languages (Rust, Python, JS/TS/TSX, Go, C, C++, Dart, PHP, Bash, Ruby, Java, C#, Kotlin, Swift, Scala, Lua, Elixir, Zig, Haskell, OCaml, Julia) | Continue expanding language adapters while preserving typed facts and provenance |
