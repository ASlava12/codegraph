...
| --- | --- | --- |
| Local AST code graph | Implemented for 17 languages (Rust, Python, JS/TS/TSX, Go, C, C++, Dart, PHP, Bash, Ruby, Java, C#, Kotlin, Swift, Scala) | Continue expanding language adapters while preserving typed facts and provenance |
