...
- keep UI graph pages, query focus, path navigation/highlighting, trace, config trace, error trace, source, insight, and agent clients on the same JSON graph model
