...
- [x] Detect config and environment keys that are read with conflicting fallback defaults across common Rust, Python, JavaScript/TypeScript, PHP, and Bash patterns.
