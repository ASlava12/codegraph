...
- [x] Add compact file summaries for agent navigation without reading raw files.
- [ ] Add graph compaction and compact node summaries for agent navigation without reading raw files.
