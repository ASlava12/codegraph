    ...
    vec![
        ...
        ApiSchemaGroup {
            ...
            endpoints: vec![
                ...
                api_get(
                    "/api/node-card",
                    "Read selected node investigation card with neighboring edges, dependency summary facets, source preview, related risks, and suggested focused graph query actions.",
                    vec![
                        path_param(),
                        query_param("node_id", true, "u64", None, "Node numeric id."),
                        query_param(
