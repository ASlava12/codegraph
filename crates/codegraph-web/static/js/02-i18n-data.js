...
const I18N = {
  en: {
    ...
    "aria.flowEntrypoint": "Flow entrypoint",
    ...
    "flow.blockHint": "click: source · dbl-click / Enter: deeper · arrows: walk · c: callers",
    "flow.noFurther": "no further flow from here (leaf)",
    "flow.showCallers": "⟵ callers",
    "flow.copyLink": "⧉ link",
    "flow.trimmed": "⚠ trimmed — drill for more",
    "aria.flowHelp": "Flow controls help",
    "flow.help.title": "Flow controls",
    "flow.help.click": "open source",
    "flow.help.deeper": "explore deeper (double-click / Enter)",
    "flow.help.walk": "walk the flow (arrows)",
    "flow.help.callers": "show callers (reverse)",
    "flow.help.focus": "focus mode — dim all but the current thread",
    "flow.help.group": "click a group to list its members",
    "flow.help.hidden": "+N calls hidden — drill in to see them",
    "flow.help.back": "breadcrumbs go back",
    "flow.help.zoom": "zoom / fit",
    "flow.help.escape": "deselect / close",

    "flow.noCallers": "nothing calls this node",
    "flow.callersOf": "callers of {label}",
    "flow.pickEntrypoint": "Entrypoint…",
    ...
    "group.flow": "Flow & navigation",
    "group.query": "Query & search",
    "group.graph": "Graph & selection",
    "group.advanced": "Advanced tools",
    "edge.explaining": "Explaining edge...",
    "edge.noExplanation": "No matching edge explanation.",
    "edge.matchesShowingFirst": "{count} matches, showing first",
    "edge.noEvidence": "No evidence metadata.",
    "query.truncated": "Result truncated by query limit.",
    "query.focusResult": "Focus result",
    "query.clearFocus": "Clear focus",
    "query.noResults": "No query results.",
    "insight.focusLabel": "Focus: {kind}",
    "page.focusInfo": "focus {shown} / {total}",
    ...
    "kind.malformed_manifest": "malformed manifest",
  ...
  ru: {
    ...
    "aria.flowEntrypoint": "Точка входа потока",
    ...
    "flow.blockHint": "клик: исходник · двойной / Enter: вглубь · стрелки: шаги · c: вызывающие",
    "flow.noFurther": "дальше потока нет (лист)",
    "flow.showCallers": "⟵ вызывающие",
    "flow.copyLink": "⧉ ссылка",
    "flow.trimmed": "⚠ обрезано — drill за полным",
    "aria.flowHelp": "Справка по управлению Flow",
    "flow.help.title": "Управление Flow",
    "flow.help.click": "открыть исходник",
    "flow.help.deeper": "вглубь (двойной клик / Enter)",
    "flow.help.walk": "шагать по потоку (стрелки)",
    "flow.help.callers": "вызывающие (обратный поток)",
    "flow.help.focus": "режим фокуса — приглушить всё, кроме текущей нити",
    "flow.help.group": "клик по группе — список участников",
    "flow.help.hidden": "+N скрытых вызовов — drill, чтобы увидеть",
    "flow.help.back": "крошки — назад",
    "flow.help.zoom": "масштаб / вписать",
    "flow.help.escape": "снять выбор / закрыть",

    "flow.noCallers": "этот узел никто не вызывает",
    "flow.callersOf": "вызывающие {label}",
    "flow.pickEntrypoint": "Точка входа…",
    ...
    "group.flow": "Поток и навигация",
    "group.query": "Запросы и поиск",
    "group.graph": "Граф и выбор",
    "group.advanced": "Расширенные инструменты",
    "edge.explaining": "Объясняю ребро...",
    "edge.noExplanation": "Нет подходящего объяснения ребра.",
    "edge.matchesShowingFirst": "{count} совпадений, показано первое",
    "edge.noEvidence": "Нет метаданных-доказательств.",
    "query.truncated": "Результат усечён лимитом запроса.",
    "query.focusResult": "Сфокусировать результат",
    "query.clearFocus": "Снять фокус",
    "query.noResults": "Нет результатов запроса.",
    "insight.focusLabel": "Фокус: {kind}",
    "page.focusInfo": "фокус {shown} / {total}",
    ...
    "kind.contains": "содержит",
    "kind.defines": "определяет",
    "kind.depends_on": "зависит от",
    "kind.control_flow": "поток управления",
    "kind.binary": "исполняемый файл",
    "kind.cmd": "команда контейнера",
    "kind.console_script": "консольная команда",
    "kind.executable": "исполняемая цель",
    "kind.ingress": "ingress",
    "kind.make_target": "цель make",
    "kind.pipeline_job": "задача пайплайна",
    "kind.route": "маршрут",
    "kind.script": "скрипт",
    "kind.service": "сервис",
    "kind.workflow_job": "задача workflow",
    "kind.workload": "рабочая нагрузка",
    "kind.clean": "чисто",
    "kind.critical": "критический",
    "kind.definitions": "определения",
    "kind.diagnostics": "диагностика",
    "kind.disabled": "отключён",
    "kind.document_symbols": "символы документа",
    "kind.exact": "точная",
    "kind.heuristic": "эвристическая",
    "kind.high": "высокий",
    "kind.hit": "попадание",
    "kind.language_server": "языковой сервер",
    "kind.low": "низкий",
    "kind.medium": "средний",
    "kind.miss": "промах",
    "kind.missing_server": "нет сервера",
    "kind.ready": "готово",
    "kind.semantic": "семантическая",
    "kind.syntactic": "синтаксическая",
    "kind.unsupported_language": "язык не поддерживается",
    "kind.workspace_symbols": "символы проекта",
    "kind.calls": "вызов",
    "kind.imports": "импорт",
    ...
    "kind.malformed_manifest": "нечитаемый манифест",
    ...
    "kind.cross_language_heuristic_edge": "межъязыковая эвристическая связь",
    "kind.dependency_cycle": "цикл зависимостей",
    "kind.duplicate_compose_published_port": "дублирующийся порт compose",
    "kind.duplicate_entrypoint_label": "дублирующееся имя точки входа",
    "kind.duplicate_framework_route": "дублирующийся маршрут",
    "kind.duplicate_function_label": "дублирующееся имя функции",
    "kind.duplicate_migration_sequence": "дублирующийся номер миграции",
    "kind.entrypoint_dead_end": "точка входа никуда не ведёт",
    "kind.rationale_risk_comment": "комментарий с пометкой риска",
    "kind.sensitive_ci_environment_literal": "секрет в CI открытым текстом",
    "kind.skipped_large_file": "пропущен большой файл",
    "kind.undeclared_flutter_asset": "ресурс Flutter без объявления",
    "kind.unmatched_platform_channel": "канал платформы без пары",
    "kind.unreachable_config_read": "недостижимое чтение конфига",
    "kind.unresolved_compose_command_path": "не найден путь команды compose",
    "kind.unresolved_compose_env_file_path": "не найден env-файл compose",
    "kind.unresolved_compose_volume_source_path": "не найден источник тома compose",
    "kind.unresolved_dockerfile_command_path": "не найден путь команды Dockerfile",
    "kind.unresolved_entrypoint_target": "не найдена цель точки входа",
    "kind.unresolved_framework_route_handler": "не найден обработчик маршрута",
    "kind.unresolved_github_actions_job_need": "не найдена зависимость задачи GitHub Actions",
    "kind.unresolved_github_actions_local_action": "не найдено локальное действие GitHub Actions",
    "kind.unresolved_github_actions_run_path": "не найден путь из шага run",
    "kind.unresolved_gitlab_ci_job_dependency": "не найдена зависимость задачи GitLab CI",
    "kind.unresolved_gitlab_ci_script_path": "не найден путь скрипта GitLab CI",
    "kind.unresolved_kubernetes_config_ref": "не найдена ссылка на конфиг Kubernetes",
    "kind.unresolved_kubernetes_ingress_backend": "не найден бэкенд Ingress",
    "kind.unresolved_kubernetes_service_selector": "не найден селектор Service",
    "kind.unresolved_makefile_command_path": "не найден путь команды Makefile",
    "kind.unresolved_sql_alter_target": "не найдена цель ALTER",
