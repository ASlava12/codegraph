...
- Manifest dependency extraction from Cargo, npm/package-lock, Go, Python, setup.py/setup.cfg/Pipfile, Composer, vcpkg, and Conan projects.
...
- JavaScript/TypeScript/npm-compatible: `package.json`, `package-lock.json`
- Go modules: `go.mod`
